      ...
      <header className="flex justify-between items-center px-5 pt-6 pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-koya-muted text-xs">Agent · Lomé, Togo 🇹🇬</p>
          </div>
        </div>
        ...
        <div className="bg-koya-surface border border-koya-border rounded-2xl p-4 space-y-2">
          ...
          <ol className="space-y-1.5">
            {[
              ...
              'Click "Confirm delivery" → status changes to Processing',
              'Hand over cash or trigger T-Money payout → Claimed',
            ].map((s, i) => (
